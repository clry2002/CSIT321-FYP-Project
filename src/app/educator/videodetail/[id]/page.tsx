...
import AssignVideoModal from '../../../components/educator/ClassroomDetails/AssignVideoModal';
...
export default function EducatorVideoDetailPage() {
  ...
  // Handle navigation back to content list
  const handleBackToContent = () => {
    if (query) {
      router.push(`/educator/availablecontent?q=${encodeURIComponent(query)}`);
    } else {
      router.back();
    }
  };
